            ...
            <div class="row">
                ...
                <main class="col-lg-9 col-xl-10">
                    ...
                    <transition-group
                        name="list"
                        tag="div"
                        class="row g-4 vocab-grid"
                    >
                        <div
                            class="col-12 col-md-6 col-xl-4"
                            v-for="pronoun in filteredpronouns"
                            :key="pronoun.id"
                        >
                                ...
                                <div class="card-content">
                                    ...
                                    >
                                        <div>
                                            ...
                                            <p class="romanization-text">
                                                {{ pronoun.romanization }}
                                            </p>
                                        </div>
                                        <button
                                            @click="speak(pronoun.korean)"
                                            class="btn-pronounce shadow-sm"
                                        >
                                    ...
                                    <div class="d-flex gap-2 mt-auto pt-3">
                                        <span
                                            v-if="pronoun.level"
                                            class="meta-badge level"
                                            >{{ pronoun.level }}</span
                                        >
                                        <span
                                            v-if="pronoun.difficulty"
                                            class="meta-badge diff"
                                            >{{ pronoun.difficulty }}</span
                                        >
                                    </div>
                                </div>
                            </div>
