<template>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content custom-plain-modal">
                <div class="modal-header border-0 pb-0">
                    ...
                    >
                        <i class="bi bi-stars me-2"></i>Korean Tutor
                    </h6>
                    <button
                        type="button"
                        class="btn-close"
                        @click="btnClosePronouncationGameModal()"
                    ></button>
                </div>
                <div class="modal-body p-4">
                    <div
                        class="d-flex justify-content-between position-relative mb-5 stage-wrapper"
                    >
                        <div
                            v-for="step in stagesCount"
                            :key="step"
                            :class="[
                                'stage-step',
                    ...
                    <div class="d-flex flex-column align-items-center py-3">
                        ...
                        >
                            ...
                            <div class="explanation-content">
                                <div
                                    class="explanation-header d-flex align-items-center mb-2"
                                >
                                    <div class="icon-badge me-2">
                                        <i
                                            class="bi bi-lightbulb-fill text-warning"
                                        ></i>
                                    </div>
                                    <h6
    ...
    <div class="modal-overlay" v-if="showFinal">
        <div class="modal-card animated-modal">
            ...
            <div class="torotot-right">
                <i class="bi bi-megaphone-fill"></i>
            </div>

            <div class="modal-header">
                <h2>
                    <i class="bi bi-trophy-fill me-2 text-warning"></i>Results
                </h2>
            </div>
            ...
            <div class="modal-body">
                ...
                <div
                    v-for="(item, index) in totalGrades"
                    :key="index"
                    class="grade-pill"
                >
    ...
    methods: {
        ...
        nextQuestion() {
            ...
            if (this.currentIndex >= this.stagesCount) {
                ...
                const sum = this.totalGrades.reduce(
                    (a, b) => a + (b.grade || 0),
                    0,
                );

                this.finalScore =
                    this.totalGrades.length > 0
...
<style
    scoped
    src="../../../../../../css/users/assets/lessons/lessongreetings.css"
></style>
<style
    scoped
