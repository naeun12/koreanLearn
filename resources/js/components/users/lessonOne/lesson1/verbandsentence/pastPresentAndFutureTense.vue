<template>
    ...
    <div class="k-card">
        ...
        <p class="lead text-secondary" style="max-width: 2000px">
            Because of this structure, Korean speakers often wait until the end
            of the sentence to understand the full meaning of the action being
            described.

            <span class="badge bg-light text-dark fw-bold"
                >Past, Present, and Future</span
            >
            are the three basic time tenses used to describe when an action
            happens. The <span class="badge bg-primary fw-bold">past</span> is
            used for actions that already happened, the
            <span class="badge bg-primary fw-bold">present</span> is used for
            actions happening now or general truths, and the
            <span class="badge bg-primary fw-bold">future</span> is used for
            actions that will happen later. These tenses help learners
            understand time clearly and express when events occur in a sentence.
        </p>
        <h2
        ...
        <div class="list-group list-group-flush gap-3">
            ...
            >
                ...
                <div>
                    <strong class="d-block text-dark"
                        >Past Transformation</strong
                    >
                    <span class="text-secondary small">
                        Attach <strong>~었/았습니다</strong> to the verb stem.
            ...
            >
                ...
                <div>
                    <strong class="d-block text-dark"
                        >Present Transformation</strong
                    >
                    <span class="text-secondary small">
                        Attach <strong>~습니다/ㅂ니다</strong> to the verb stem.
                        Used for facts, habits, or current states.
                    </span>
                </div>
            </div>
            ...
            >
                ...
                <div>
                    <strong class="d-block text-dark"
                        >Future Transformation</strong
                    >
                    <span class="text-secondary small">
                        Attach <strong>~겠습니다</strong> to the verb stem.
                        Expresses a strong intention or a planned event.
                    </span>
                </div>
            </div>
            <div
            ...
            >
                ...
                >
                    ...
                    <div>
                        <div class="w-75">
                            <strong class="d-block mb-1" style="color: #ffffff"
                                >Pro Tip: The Time Anchor</strong
                            >
                            <p class="mb-0 opacity-75 small">
                                In Korean, the verb acts as your
                                <strong>"Time Anchor."</strong> No matter how
                                long your sentence is, the final verb ending is
                                what determines the timeline locking in whether
                                the action is already finished (Past), currently
                                happening (Present), or still a plan (Future).
                            </p>
                        </div>
                    </div>
                    <button
                        class="example-sentences ms-auto"
                        @click="btnExampleOpen()"
                    >
                        Example
                    </button>
                </div>
    ...
    <div
        class="k-card mt-4"
        v-if="isExamplePastPresentAndFutureTense"
        ref="ExamplePastPresentAndFutureTense"
    >
        ...
        <p class="text-muted small mb-4">
            Observe how the base verb remains the "anchor" while the suffixes
            shift to change the timeline from past to future.
        </p>
        <div
                    ...
                    <tbody class="bg-white">
                        ...
                        >
                            ...
                            <td>
                                ...
                                <span
                                    class="d-block text-secondary smaller opacity-75"
                                    >I eat rice.</span
                                >
                            </td>
                            <td>
                ...
                >
                    <div class="mb-4 mb-md-0 text-center text-md-start">
                        ...
                        <p class="mb-0 opacity-75 fs-5">
                            Test your skills on
                            <strong>Past, Present, and Future</strong> sentence
                            structures
                        </p>
                    </div>
                ...
                <div class="modal-body p-4">
                    ...
                    >
                        ...
                        <span class="text-muted small fw-bold"
                            >{{ (currentIndex / 10) * 100 }}% Complete</span
                        >
                    </div>
                    <div
                        class="progress"
...
export default {
    ...
    methods: {
        btnExampleOpen() {
            this.isExamplePastPresentAndFutureTense =
                !this.isExamplePastPresentAndFutureTense;
        ...
        shuffleQuestions() {
            this.QuizQuestions = this.QuizQuestions.map((q) => ({ ...q })).sort(
                () => Math.random() - 0.5,
            );
        },
